  ...
  public static void main(String[] args) {
    ...
    while (indice < MAX_EMPLEADOS && continuar) {
      ...
      if (respuesta.equals("1")) {
        ...
        empleados[indice] = new Administrativo(dni, nombre, apellido, email, sueldoBase, hrExtra, hrMes);
        ...
        empleados[indice] = new Vendedor(dni, nombre, apellido, email, sueldoBase, porcenComision, totalVentas);
      }
